...
//            IQueryProcessor<BaseEntityDummy> dummyQuery = new QueryBaseDummy<BaseEntityDummy>(queryableDatabase);
...
//            IQueryProcessor<BaseEntityDummy> dummyQuery = new QueryBaseDummy<BaseEntityDummy>(fakeQueryableDatabase.Object);
...
//                IQueryProcessor<BaseEntityDummy> dummyQuery = new QueryBaseDummy<BaseEntityDummy>(fakeQueryableDatabase.Object);
//                var result = dummyQuery.ProcessQuery();
